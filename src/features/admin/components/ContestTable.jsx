...
//   const [openMenu, setOpenMenu] = useState(null); // ✅ action menu state
...
//       // ✅ FIXED DEADLINE COLUMN
//       {
//         header: "Deadline",
//         accessorKey: "deadline", // ✅ FIX
//         cell: ({ getValue }) => formatDate(getValue()),
//       },
...
//       // ✅ MODERN ACTION MENU (CLICK BASED)
//       {
//         id: "actions",
//         header: "",
//         cell: ({ row }) => (
...
//                 <button
//                   onClick={() => {
//                     onDelete(row.original.id); // ✅ backend uses id
//                     setOpenMenu(null);
//                   }}
...
//           className="px-4 py-2 bg-[#82C600] text-white rounded hover:bg-[#6ea800] transition disabled:opacity-50 disabled:bg-gray-300"
//         >
//           Previous
//         </button>
