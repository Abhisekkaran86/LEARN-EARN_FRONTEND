...
//               <div
//                 key={i}
//                 className="p-4 bg-[#82C600]/5 border border-[#82C600]/20 rounded-xl text-sm text-gray-700"
//               >
//                 ✅ {rule}
//               </div>
//             ))}
...
//                   : "border-gray-200 hover:border-[#82C600]"
//               }`}
//             >
//               <div className="flex items-center gap-2 mb-2">
//                 <User size={18} className="text-[#82C600]" />
...
//             >
//               <div className="flex items-center gap-2 mb-2">
//                 <Users size={18} className="text-[#82C600]" />
...
//               : "You will create or join a team"}
//           </p>

//           <button
//             onClick={() => {
//               alert(`🎉 Joined as ${mode}`);
//             }}
//             className="px-6 py-2 bg-gradient-to-r from-[#82C600] to-[#a3e635] text-white rounded-xl shadow hover:scale-105 transition"
//           >
//             🚀 Participate Now
//           </button>
